...
def get_white_dwarfs(stars: pd.DataFrame,
    ...
    and halo
    :param ifmr_parameter: factor by which WD mass (calculated from
    Initial-to-Final Mass Relation (IFMR)) is multiplied (default 1.)
    :param chandrasekhar_limit: maximum mass of a stable WD (default 1.4)
    :param max_mass: maximum mass of a main sequence star that can generate
    a WD (default 10.5)
    :param solar_metallicity: metallicity assigned to all thin and thick disks
...
def get_main_sequence_lifetimes(*,
    ...
    """
    Calculates lifetime of a main sequence star according to model by
    Leandro & Renedo et al.(2010).
