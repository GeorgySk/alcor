...
C     ---   Declaration of variables   ---
      ...
      real mass,tcool,y
      real mv,cbv,cvi,cvr,cuv,zlte,zlr,G
      real lum,c1,c2,c3,c4,c5,teff,xlog
...
C     ---   Dimensions   ---
      ...
      real mvtabone(ncol,nrow),ltabone(ncol,nrow)
      real lgtabone(ncol,nrow),lgtetabone(ncol,nrow)
      ...
      real tprewd1(ncol),tprewd2(ncol2)
...
C   --- G in cm/s² kg; M in kg and R in cm ---
      G = 6.67e-5
      xlog = log10(G) + log10(mass * (1.989e30)) 
